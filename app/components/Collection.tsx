...
const fragrances: Fragrance[] = [
  {
    ...
    name: 'Chanel',
    available: true,
    imageStyle: { transform: 'translateY(20px) scale(1.2)', transformOrigin: 'top center', objectFit: 'contain' },
    price: 2500,
  },
  {
    img: '/aventus.png',
            ...
            <div className="perf-card">
              <div className="card-img-wrap" style={{ overflow: 'hidden' }}>
                ...
                <img
                  src={f.img}
                  alt={f.alt}
                  style={f.available ? (f.imageStyle || { transform: 'scale(1.4)', objectFit: 'contain' }) : { filter: 'grayscale(50%) blur(15px) brightness(0.6)', transform: 'scale(1.2)' }}
                />
